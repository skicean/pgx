...
import (
	...
	"github.com/skicean/pgx/v5/internal/pgmock"
...
// https://github.com/skicean/pgx/issues/859
...
//
// See https://github.com/skicean/pgx/issues/374.
...
func TestConnCopyFromQuerySyntaxError(t *testing.T) {
	...
	// break the connection. See https://github.com/skicean/pgconn/pull/127 for context.
	inputRows := [][][]byte{}
	for i := 0; i < 1000; i++ {
		a := strconv.Itoa(i)
		b := "foo " + a + " bar"
...
// https://github.com/skicean/pgconn/issues/21
...
// https://github.com/skicean/pgconn/issues/128
...
// https://github.com/skicean/pgx/issues/659
...
// https://github.com/skicean/pgx/issues/800
...
// https://github.com/skicean/pgconn/issues/27
