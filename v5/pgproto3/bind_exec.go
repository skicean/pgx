...
func (*BindExec) Frontend() {}

// Decode decodes src into dst. src must contain the complete message with the exception of the initial 1 byte message
// type identifier and 4 byte message length.
func (dst *BindExec) Decode(src []byte) error {
	*dst = BindExec{}
...
func (src *BindExec) Encode(dst []byte) []byte {
	dst = append(dst, 'b')
	sp := len(dst)
...
func (src BindExec) MarshalJSON() ([]byte, error) {
...
func (dst *BindExec) UnmarshalJSON(data []byte) error {
