...
import (
	...
	"github.com/skicean/pgx/v5/internal/anynil"
	"github.com/skicean/pgx/v5/internal/sanitize"
	"github.com/skicean/pgx/v5/internal/stmtcache"
...
func ConnectConfig(ctx context.Context, connConfig *ConnConfig) (*Conn, error) {
	...
	// connections with the same config. See https://github.com/skicean/pgx/issues/618.
